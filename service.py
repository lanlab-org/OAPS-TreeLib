...
def admin():
    if not session.get('logged_in'):
        ...
        return render_template('admin.html', articles=articles, comments=comments, visitors=visitors)
...
@app.route('/banned/<int:id>')
def banned_visitor(id):
    ...
    try:
        ...
        return 'Error banned / cancel banned visitor!.'
